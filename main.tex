...
\end{cdefinition}
\begin{clemma}
	$\Phi_{\rm{Lpro}}$ is closed under the following operations in the double category $\dc{PROF}$:
	\begin{itemize}
		\item %
			Restriction on left by arbitrary functors.
			\TODO[More explanation]
		\item %
			Composition on left by arbitrary $\b{SET}$-profunctors.
		\item %
